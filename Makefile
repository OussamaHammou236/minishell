...
OBJ= pars/pars.c pars/set_spase.c pars/expand.c pars/check_herdoc.c pars/check_str.c pars/tockention.c libft/ft_strncmp.c pars/free_trash.c pars/expand_2.c\
