...
OBJ= pars/pars.c pars/set_spase.c pars/expand.c pars/tockention.c libft/ft_strncmp.c \
libft/ft_split.c libft/ft_substr.c libft/ft_itoa.c libft/ft_strdup.c libft/ft_strlen.c libft/ft_strlcat.c \
